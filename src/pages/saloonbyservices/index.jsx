...
class SaloonListServices extends Component {
  constructor() {
    super();
    this.state = {
      showFilters: false,
  ...
  componentDidMount() {
    ...
    SaloonApi.SaloonbyServices(data).then((res) => {
          ...
          <div className="soloneHeaderCon">
            <div>
              ...
              <p>
                ...
                variety of latest saloons in your nearby location
              </p>
            </div>
          </div>
        </section>
                              ...
                              <div
                                className={
                                  this.state.showFilters
                                    ? "col-lg-4 col-xl-4 col-md-6 mb-3"
                                    : "col-lg-4 col-xl-3 col-md-4 mb-3"
                                }
                                onClick={() => {
                                  this.props.history.push(
                                    `/saloon/${data._id}`
